...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    // Query de Delete
    $sql_critica = "DELETE FROM critica WHERE filme_cri in (select filme.cod_fil from filme where filme.genero_fil = ?)";
    $sql_filme = "DELETE FROM filme WHERE genero_fil = ?";
    $sql_diretor = "DELETE FROM genero where cod_gen = ?";
            ...
            <div class="col-md-12 d-flex align-items-stretch grid-margin">
              <div class="row flex-grow">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Deletar Gênero</h4>
                      <form class="forms-sample" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-danger">
                            ...
                            <h3 class="display-3 alert">Tem certeza? Se deletar esse gênero, TODOS os filmes e TODAS as críticas serão removidas deste gênero.</h3>
                            <p>
